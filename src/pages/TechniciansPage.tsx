...
import { Users, CheckCircle, XCircle, Loader2, ShieldCheck, Wrench, Crown } from "lucide-react";
...
const TechniciansPage = () => {
  ...
  const RoleIcon = (role: string) => roleIcons[role] || Wrench;
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {users.map((u: any) => {
            const Icon = RoleIcon(u.requested_role);
            return (
